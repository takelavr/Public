...
@Data
public class DistanceCalculate implements CrowfligthInterface, DataMatrixInterface {
    ...
    public String calculateDataMatrix(City fromCity, City toCity) {
        return "Result: " + new DecimalFormat("#0.00").format(calculateDataMatrix(fromCity.getLatitude(),
                                                                                          fromCity.getLongitude(),
                                                                                          toCity.getLatitude(),
                                                                                          toCity.getLongitude()))
                + " Km";
